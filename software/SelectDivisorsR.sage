            ...
            if sturm_count(P_alpha,interval_max[0],interval_max[1])==0:
                ...
                if sturm_count(A,interval_max[0],interval_max[1]) ==0:
                    ...
                    for f, e in g.factor():
                        ...
                        d = Vf.degree()
                        H = A(u).resultant(Vf(t*u))
                        Vm = f(u).resultant(f(t*u))
                        Vm = (Vm // Vm.gcd(Vm.derivative())).monic()
                        print("Vm")
                        print(Vm)
                        if H(1)==0:
                            if e>1:
                                ...
                                for Hf, _ in Vm.factor(): 
                                    print(Hf)
                                    if not Hf.is_cyclotomic():
                                        print(Hf)
                                        print("Non cyclotomic")
                                        return False
                    return True
    else:
        return True
